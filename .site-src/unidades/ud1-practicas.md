...
| --- | --- | --- |
| ACT-1.1 · Los ordenadores han llegado | `ACT-1.1_apellido_nombre_instalacion.pdf` | Instalación/configuración documentada |
| ACT-1.2 · Auditoría de licencias | `ACT-1.2_apellido_nombre_licencias.pdf` | Informe ejecutivo de una página |
| ACT-1.3 · Compatibilidad entre suites | `ACT-1.3_apellido_nombre_compatibilidad.pdf` | Pruebas ODF/OOXML y política |
| ACT-1.4 · Diagnóstico y reparación | `ACT-1.4_apellido_nombre_incidencias.pdf` | Parte síntoma-causa-solución-verificación |
| ACT-1.5 · Auditoría de hardware | `ACT-1.5_apellido_nombre_ficha_equipo.pdf` | Inventario y requisitos |

## Navegación

- [Abrir ACT-1.1](ud01-actividad-1.md)
- [Abrir ACT-1.2](ud01-actividad-2.md)
- [Abrir ACT-1.3](ud01-actividad-3.md)
- [Abrir ACT-1.4](ud01-actividad-4.md)
- [Abrir ACT-1.5](ud01-actividad-5.md)
- [Consultar rúbrica](ud01-rubrica.md)
