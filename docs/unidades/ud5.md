# UD05 · Imagen digital — Diseñamos la identidad visual

**Duración:** 24 horas. **RA principal:** RA5. La impresión 3D se integra como contexto aplicado de preparación, exportación, impresión y control de calidad de la imagen corporativa; no crea un RA adicional.
...
- **A1 · Auditoría de marca (3 h):** adquirir una imagen con periférico, revisar la identidad de UD02 y crear un moodboard con fuentes declaradas.
- **A2 · Cartel de lanzamiento (7 h):** boceto, producción por capas y prueba de lectura.
- **A3 · Una campaña, varios formatos (5 h):** adaptar sin deformar a banner y tarjeta/firma.
- **A4 · Paquete de entrega (3 h):** originales editables, exportaciones optimizadas y guía de usos incorrectos.
...
| --- | ---: | --- |
| Lenguaje visual y derechos | 3 | Auditoría de marca, moodboard y registro de fuentes. |
| Producción por capas | 7 | Cartel editable con jerarquía, recortes limpios y texto legible. |
| Adaptación multiformato | 5 | Banner y tarjeta que conservan el mensaje sin deformaciones. |
| Entrega profesional | 3 | Originales, exportaciones y guía de uso empaquetados. |
